...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const searchType = urlParams.get('type'); const searchWord = urlParams.get('searchword'); // Set the values
    if (searchType) { document.getElementById('search-type').value = searchType; } if
        (searchWord) {
